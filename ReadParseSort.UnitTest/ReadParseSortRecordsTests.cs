...
namespace UnitTestReadParseSort
{
    [TestClass]
    public class ReadParseSortRecordsTests
    {
        [TestMethod]
        public void AddDelimiterToDelimiterList_Succeeds()
        {
        ...
        [TestMethod]
        public void AddFileToFileList_Succeeds()
        {
            var readParseSort = new ReadParseSortRecords();
            var path = @"C:\Program Files\test.txt";
            readParseSort.AddFileToFileList(path);

            Assert.IsTrue(readParseSort.FileList.Contains(path));
        }

        [TestMethod]
        public void GetPersonFromTextInput_DelimiterPipe_ObjectCompare_Succeeds()
        {
            var readParseSort = new ReadParseSortRecords();
        ...
        [TestMethod]
        public void GetPersonFromTextInput_DelimiterPipe_Succeeds()
        {
            var readParseSort = new ReadParseSortRecords();
        ...
        [TestMethod]
        public void GetPersonFromTextInput_DelimiterComma_Succeeds()
        {
            var readParseSort = new ReadParseSortRecords();
        ...
        [TestMethod]
        public void GetPersonFromTextInput_DelimiterSpace_Succeeds()
        {
            var readParseSort = new ReadParseSortRecords();
        ...
        [TestMethod]
        public void AddPersonToPersonList_Succeeds()
        {
            var readParseSort = new ReadParseSortRecords();
        ...
        [TestMethod]
        public void SortPersonsByGenderAscLastNameAsc_Succeeds()
        {
            var readParseSort = new ReadParseSortRecords();
        ...
        [TestMethod]
        public void SortPersonsByDateOfBirthAsc_Succeeds()
        {
            var readParseSort = new ReadParseSortRecords();
        ...
        [TestMethod]
        public void SortPersonsByLastNameDesc_Succeeds()
        {
            var readParseSort = new ReadParseSortRecords();
        ...
        [TestMethod]
        public void SortPersonsByLastName_Succeeds()
        {
            var readParseSort = new ReadParseSortRecords();
